...
leafletDirective.directive("leaflet", ["$http", "$log", "$parse", function ($http, $log, $parse) {
    ...
    return {
        ...
        template: '<div class="angular-leaflet-map dark"></div>',
        link: function ($scope, element, attrs /*, ctrl */) {
            ...
            var map = L.mapbox.map(element[0], $scope.map, { maxZoom: $scope.leaflet.maxZoom });
            ...
            function setupTiles(){
                ...
                if ($scope.tiles) {
                    ...
                    if ($scope.tiles.tileLayerOptions) {
                        $scope.leaflet.tileLayerOptions = $scope.tiles.tileLayerOptions;
                    }
                }

                var tileLayerObj = L.mapbox.tileLayer(
                    $scope.leaflet.tileLayer, $scope.leaflet.tileLayerOptions);
